...
import { createForumPostApi } from '@revit/api/forum/post'
import { useForumPostStore } from '../../../store/forum.store'
...
const CreateForumPost = ({
  ...
  const { fetchForumPosts } = useForumPostStore()
  ...
  const handleCreatePost = async () => {
    ...
    const post = { forumId, caption, images, rating }

    setStatus(LOADING)
    const error = await createForumPostApi(post)
    setStatus(IDLE)
